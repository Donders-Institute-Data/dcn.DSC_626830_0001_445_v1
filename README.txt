...
Timonidis, N. (Nestor), Bakker, R. (Rembrandt), Alberto Llera, Tiesinga, P.H.E. (Paul) (2021).
Integrative multiscale frameworks for predicting a cell-type-specific mouse mesoconnectome [Data set].
https://doi.org/10.34973/6h4f-ts87.

# Abstract

Integrative multiscale frameworks for predicting a cell-type-specific mouse mesoconnectome

# Background information

You can find more information, including relevant publications pertaining to this dataset on the collection overview page at https://doi.org/10.34973/6h4f-ts87.
